...
<head>
    ...
    <title>Register - EliteStore</title>
...
<body>
    ...
    <div class="register-container">
        ...
        <div class="links">
            <p style="color: rgba(248, 249, 250, 0.7); margin-bottom: 0.5rem;">Already have an account?</p>
            <a href="index.php?action=login">Login Now</a>
        </div>
    </div>
